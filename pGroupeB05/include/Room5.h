...
const int NUM_OBSTACLES5 = 3;
const int NUM_ENEMIES1_ROOM5 = 2;
const int NUM_ENEMIES2_ROOM5 = 1;

class Room5: public State
{
    private:
    ...
    public:
        Room5(sf::RenderWindow& app,StateManager& stateManager,Player& p1);
        virtual ~Room5();
