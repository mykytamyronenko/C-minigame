...
const int NUM_OBSTACLES2 = 5;
const int NUM_ENEMIES1_ROOM2 = 2;
const int NUM_ENEMIES2_ROOM2 = 2;
...
class Room2: public State
{
    private:
        ...
        sf::Sprite doorToR3Sprite; // Déclaration du sprite pour la porte
        sf::Texture doorToR3Texture; // Déclaration de la texture pour la porte
    ...
    public:
        Room2(sf::RenderWindow& app,StateManager& stateManager,Player& p1);
        virtual ~Room2();
