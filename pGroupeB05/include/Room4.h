...
const int NUM_OBSTACLES4 = 5;
const int NUM_ENEMIES1_ROOM4 = 2;
const int NUM_ENEMIES2_ROOM4 = 2;
...
class Room4: public State
{
    ...
    public:
        Room4(sf::RenderWindow& app,StateManager& stateManager,Player& p1);
        virtual ~Room4();
